...
<section class="report-section">
  <h2>Audit Check</h2>
  <p style="color:var(--text-sec); font-size:11.5px; margin-bottom:14px;">
    Audit document compared against the SOP-extracted graph.
...
<div class="report-footer">
  ...
  <br>This report consolidates the extracted graph, process-mining, gap, audit, object-model, and optimisation data already produced by the engine.
</div>"""
